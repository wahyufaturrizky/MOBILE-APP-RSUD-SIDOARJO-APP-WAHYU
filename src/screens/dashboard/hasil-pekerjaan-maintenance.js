...
class HasilPekerjaanMaintenance extends Component {
      ...
      <Container style={styles.container}>
        ...
        <ScrollView>
          <Content padder> 
            ...
            <Grid>
              <Col>
                <TouchableOpacity onPress={()=> this.props.navigation.navigate("TiketKeluhanMaintenance")}>
                  <Card>
              ...
              <Col>
                <TouchableOpacity onPress={()=> this.props.navigation.navigate("ViewPermintaanMaintenancePartFive")}>
                  <Card>
            ...
            <List>
              <Card>
                <ListItem>
                  <Left><H3 style={{color: "#F2994A", fontWeight: "bold"}}>Maintenance</H3></Left>
            ...
            <Button
              ...
              onPress={()=> this.props.navigation.navigate("CheckOutScanQRCodeMaintenance")}>
                <Text>CHECK OUT</Text>
            </Button>
...
export default HasilPekerjaanMaintenance;
