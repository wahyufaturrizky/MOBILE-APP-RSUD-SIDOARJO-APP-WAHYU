...
class ViewPermintaanPerbaikanPartFive extends Component {
      ...
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          ...
          <Right>
            <Button 
              transparent
              onPress={() => this.props.navigation.navigate("TiketKeluhanPerbaikan")}
            >
        ...
        <ScrollView>
          <Content padder>
            ...
            <Button onPress={()=> this.props.navigation.navigate("DetailAsetHistoryPartFive")} style={{backgroundColor: "#0677F9", marginTop: 16}} block><Text>View History</Text></Button>
...
export default ViewPermintaanPerbaikanPartFive;
