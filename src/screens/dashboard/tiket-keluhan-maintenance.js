...
class TiketKeluhanMaintenance extends Component {
    ...
    return (
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          <Left>
            <Title style={{color: "#4F4F4F"}}>Tiket Keluhan</Title>
          </Left>
          <Right>
            <Button transparent onPress={() => this.props.navigation.navigate("HasilPekerjaanMaintenance")}>
...
export default TiketKeluhanMaintenance;
