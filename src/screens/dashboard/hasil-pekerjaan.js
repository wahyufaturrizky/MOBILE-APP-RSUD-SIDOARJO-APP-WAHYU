      ...
      <Container style={styles.container}>
        ...
        <ScrollView>
          <Content padder> 
            ...
            <Grid>
              <Col>
                <TouchableOpacity onPress={()=> this.props.navigation.navigate("TiketKeluhanPerbaikan")}>
                  <Card>
              ...
              <Col>
                <TouchableOpacity onPress={()=> this.props.navigation.navigate("ViewPermintaanPerbaikanPartSix")}>
                  <Card>
            ...
            <Button
              ...
              onPress={()=> this.props.navigation.navigate("CheckOutScanQRCodePerbaikan")}>
                <Text>CHECK OUT</Text>
            </Button>
