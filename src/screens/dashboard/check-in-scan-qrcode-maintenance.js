...
class CheckInScanQRCodeMaintenance extends Component {
      ...
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          <Left>
            <Button 
              transparent
              onPress={() => this.props.navigation.navigate("DetailTiketMaintenance")}>
        ...
        <ScrollView>
          <Content padder>
            ...
            <Card>
              <CardItem cardBody>
                <Button onPress={() => this.props.navigation.navigate("ProsesIdentifikasiPartOneMaintenance")} block style={{height:300, width: null, flex: 1}} transparent><Image source={cardImage04}  /></Button>
              </CardItem>
            </Card>
...
export default CheckInScanQRCodeMaintenance;
