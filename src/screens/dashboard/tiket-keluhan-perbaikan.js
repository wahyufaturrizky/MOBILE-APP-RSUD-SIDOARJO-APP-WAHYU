...
class TiketKeluhanPerbaikan extends Component {
    ...
    return (
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          ...
          <Right>
            <Button transparent onPress={() => this.props.navigation.navigate("HasilPekerjaan")}>
        ...
        <ScrollView style={{marginTop: 8}} >
          <Content padder>
            ...
            <List>
              <Card>
                <ListItem onPress={() => this.props.navigation.navigate("ViewPermintaanPerbaikanPartFive")}>
                  <Left>
...
export default TiketKeluhanPerbaikan;
