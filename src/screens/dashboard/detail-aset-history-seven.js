...
class DetailAsetHistoryPartSeven extends Component {
      ...
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          ...
          <Right>
            <Button 
              transparent
              onPress={() => this.props.navigation.navigate("ViewPermintaanPerbaikanPartSeven")}
            >
...
export default DetailAsetHistoryPartSeven;
