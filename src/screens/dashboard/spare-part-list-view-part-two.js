...
class SparePartListViewPartTwo extends Component {
    ...
    return (
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          <Left>
            <Button transparent onPress={() => this.props.navigation.navigate("ProsesIdentifikasiPartTwo")}>
        ...
        <ScrollView style={{marginTop: 8}} >
          <Content padder>
            ...
            <H3 style={{color: "#6AC101", fontWeight: "normal", marginBottom: 16}}>List Spare Part</H3>
              ...
              <List>
                <Card>
                  <ListItem onPress={() => this.props.navigation.navigate("DetailSparePartTwo")} thumbnail>
                    <Left>
...
export default SparePartListViewPartTwo;
