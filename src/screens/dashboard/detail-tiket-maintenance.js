...
class DetailTiketMaintenance extends Component {
    ...
    return (
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          <Left>
            <Button transparent onPress={() => this.props.navigation.navigate("TiketMaintenance")}>
        ...
        <ScrollView style={{marginTop: 8}} >
          <Content padder>
            ...
            <List>
              <Card>
                <ListItem onPress={() => this.props.navigation.navigate("ViewPermintaanMaintenance")}>
                  <Left>
            ...
            <Button
              rounded onPress={() => this.props.navigation.navigate("CheckInScanQRCodeMaintenance")} block style={{backgroundColor: "#2D9CDB", marginTop: 16}}>
                <Text>CHECK IN</Text>
            </Button>
...
export default DetailTiketMaintenance;
