...
class ReviewHasilPekerjaan extends Component {
      ...
      <Container style={styles.container}>
        ...
        <ScrollView>
          <Content padder> 
            ...
            <Grid>
              <Col>
                <TouchableOpacity onPress={()=> this.props.navigation.navigate("TiketKeluhanPerbaikanTwo")}>
                  <Card>
              ...
              <Col>
                <TouchableOpacity onPress={()=> this.props.navigation.navigate("ViewPermintaanPerbaikanPartEight")}>
                  <Card>
...
export default ReviewHasilPekerjaan;
