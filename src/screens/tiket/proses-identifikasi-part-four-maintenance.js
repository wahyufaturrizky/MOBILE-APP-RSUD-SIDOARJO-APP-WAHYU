...
class ProsesIdentifikasiPartFourMaintenance extends Component {
      ...
      <Container style={styles.container}>
        ...
        <ScrollView style={{marginTop: 8}} >
          <Content padder>
            ...
            <List>
              <Card>
                <ListItem onPress={()=> this.props.navigation.navigate("ViewPermintaanMaintenancePartSeven")}>
                  <Left>
...
export default ProsesIdentifikasiPartFourMaintenance;
