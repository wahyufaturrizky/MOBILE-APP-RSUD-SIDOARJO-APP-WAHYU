...
class CheckOutScanQRCodePerbaikanPartTwo extends Component {
      ...
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          <Left>
            <Button 
              transparent
              onPress={() => this.props.navigation.navigate("HasilPekerjaanPartTwo")}>
              <Icon style={{color:"#4F4F4F"}} name="md-arrow-back" />
            </Button>
          </Left>
          <Body>
            <Title style={{color: "#4F4F4F"}}>Check Out</Title>
          </Body>
        </Header>
        ...
        <ScrollView>
          <Content padder>
            ...
            <Card>
              <CardItem cardBody>
                <Button onPress={() => this.props.navigation.navigate("Dashboard")} block style={{height:300, width: null, flex: 1}} transparent><Image source={cardImage04}  /></Button>
              </CardItem>
            </Card>
            ...
            <Text>Dengan melakukan Scan QR Code berarti Anda telah berada di ruangan (Check Out), dan siap untuk melakukan proses perbaikan.</Text>
...
export default CheckOutScanQRCodePerbaikanPartTwo;
