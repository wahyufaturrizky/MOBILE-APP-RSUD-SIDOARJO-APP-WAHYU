...
class CheckInScanQRCodeTwo extends Component {
      ...
      <Container style={styles.container}>
        ...
        <ScrollView>
          <Content padder>
            ...
            <Card>
              <CardItem cardBody>
                <Button onPress={() => this.props.navigation.navigate("ProsesIdentifikasiPartFour")} block style={{height:300, width: null, flex: 1}} transparent><Image source={cardImage04}  /></Button>
              </CardItem>
            </Card>
...
export default CheckInScanQRCodeTwo;
