...
class ViewPermintaanMaintenancePartSix extends Component {
      ...
      <Container style={styles.container}>
        ...
        <ScrollView>
          <Content padder>
            ...
            <Button onPress={()=> this.props.navigation.navigate("DetailAsetHistoryPartThirteen")} style={{backgroundColor: "#0677F9", marginTop: 16}} block><Text>View History</Text></Button>
...
export default ViewPermintaanMaintenancePartSix;
