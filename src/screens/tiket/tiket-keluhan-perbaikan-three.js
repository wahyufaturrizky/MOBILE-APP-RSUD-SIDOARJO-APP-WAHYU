...
class TiketKeluhanPerbaikanThree extends Component {
    ...
    return (
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          ...
          <Right>
            <Button transparent onPress={() => this.props.navigation.navigate("HasilPekerjaanPartTwo")}>
        ...
        <ScrollView style={{marginTop: 8}} >
          <Content padder>
            ...
            <List>
              <Card>
                <ListItem onPress={() => this.props.navigation.navigate("ViewPermintaanPerbaikanPartEleven")}>
                  <Left>
...
export default TiketKeluhanPerbaikanThree;
