...
class ViewPermintaanPerbaikanPartSix extends Component {
      ...
      <Container style={styles.container}>
        ...
        <ScrollView>
          <Content padder>
            ...
            <Button onPress={()=> this.props.navigation.navigate("DetailAsetHistoryPartSix")} style={{backgroundColor: "#0677F9", marginTop: 16}} block><Text>View History</Text></Button>
...
export default ViewPermintaanPerbaikanPartSix;
