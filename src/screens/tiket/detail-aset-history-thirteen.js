import { Body, Button, Card, Container, Content, H3, Header, Icon, Left, List, ListItem, Right, Text, Title } from "native-base";
import React, { Component } from "react";
import { ScrollView } from "react-native-gesture-handler";
import styles from "./styles";


class DetailAsetHistoryPartThirteen extends Component {
      ...
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          ...
          <Right>
            <Button 
              transparent
              onPress={() => this.props.navigation.navigate("ViewPermintaanMaintenancePartSix")}
            >
...
export default DetailAsetHistoryPartThirteen;
