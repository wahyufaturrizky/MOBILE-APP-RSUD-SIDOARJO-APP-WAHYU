...
class ViewPermintaanMaintenancePartThree extends Component {
      ...
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          ...
          <Right>
            <Button 
              transparent
              onPress={() => this.props.navigation.navigate("ProsesIdentifikasiPartTwoMaintenance")}
            >
...
export default ViewPermintaanMaintenancePartThree;
