...
class DetailTiketPerbaikanPartTwo extends Component {
    ...
    return (
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          <Left>
            <Button transparent onPress={() => this.props.navigation.navigate("MenuTiketPerbaikan")}>
        ...
        <ScrollView style={{marginTop: 8}} >
          <Content padder>
            ...
            <List>
              <Card>
                <ListItem onPress={() => this.props.navigation.navigate("ViewPermintaanPerbaikanPartNine")}>
                  <Left>
            ...
            <Button
              rounded onPress={() => this.props.navigation.navigate("CheckInScanQRCodeTwo")} block style={{backgroundColor: "#2D9CDB", marginTop: 16}}>
                <Text>CHECK IN</Text>
            </Button>
...
export default DetailTiketPerbaikanPartTwo;
