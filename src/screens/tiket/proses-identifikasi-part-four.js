...
class ProsesIdentifikasiPartFour extends Component {
          ...
          <Content padder>
            ...
            <Modal animationType="slide" transparent={false} visible={this.state.modalVisible} onRequestClose={()=> {
              ...
              <View style={{marginTop: 22, paddingHorizontal: 16}}>
                <H3 style={{color: "#6AC101", fontWeight: "bold", marginBottom: 16}}>Pilih Spare Part</H3>
                      ...
                      <Left>
                        ...
                        <Body>
                          ...
                          <Item rounded style={{marginTop: 8, backgroundColor: "white"}}>
                            ...
                            <Input placeholder='Cari spare part' />
                          </Item>
                        </Body>
                      </Left>
                    </ListItem>
            ...
            <List>
              <Card>
                <ListItem onPress={()=> this.props.navigation.navigate("ViewPermintaanPerbaikanPartTen")}>
                  <Left>
...
export default ProsesIdentifikasiPartFour;
