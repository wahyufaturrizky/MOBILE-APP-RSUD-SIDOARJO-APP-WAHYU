...
class ViewPermintaanPerbaikanPartSeven extends Component {
      ...
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          ...
          <Right>
            <Button 
              transparent
              onPress={() => this.props.navigation.navigate("TiketKeluhanPerbaikanTwo")}
            >
        ...
        <ScrollView>
          <Content padder>
            ...
            <Button onPress={()=> this.props.navigation.navigate("DetailAsetHistoryPartSeven")} style={{backgroundColor: "#0677F9", marginTop: 16}} block><Text>View History</Text></Button>
...
export default ViewPermintaanPerbaikanPartSeven;
