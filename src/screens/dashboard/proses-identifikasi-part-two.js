      ...
      <Container style={styles.container}>
        ...
        <ScrollView style={{marginTop: 8}} >
          <Content padder>
            ...
            <List>
              <Card>
                <ListItem onPress={()=> this.props.navigation.navigate("ViewPermintaanPerbaikanPartThree")}>
                  <Left>
            ...
            <H3 note style={{marginTop: 24, color: "#6AC101", fontWeight: "nomral", marginBottom: 16}}>Keluhan Anda</H3>
            ...
            <Card style={{marginTop: 16}}>
              <CardItem button onPress={() => this.props.navigation.navigate("SparePartListViewPartTwo")} style={{backgroundColor:"#6AC101"}}>
                <Left/>
            ...
            <List style={{marginTop: 16}}>
              <H3  style={{color: "#6AC101", fontWeight: "normal"}}>Hasil Identifikasi</H3>
              <Card>
                <ListItem>
                  <Left>
                    <Body>
            ...
            <H3 note style={{marginTop: 24, color: "#6AC101", fontWeight: "normal", marginBottom: 16}}>Keterangan</H3>
