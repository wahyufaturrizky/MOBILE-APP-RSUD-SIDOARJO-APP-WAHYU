import { Badge, Button, Card, CardItem, Container, Content, H3, Header, Icon, Left, Right, Text, Title } from "native-base";
...
class ViewPermintaanMaintenancePartSeven extends Component {
      ...
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          ...
          <Right>
            <Button 
              transparent
              onPress={() => this.props.navigation.navigate("ProsesIdentifikasiPartFourMaintenance")}
            >
        ...
        <ScrollView>
          <Content padder>
            ...
            <Button onPress={()=> this.props.navigation.navigate("DetailAsetHistory")} style={{backgroundColor: "#0677F9", marginTop: 16}} block><Text>View History</Text></Button>
...
export default ViewPermintaanMaintenancePartSeven;
