...
class ViewPermintaanMaintenancePartTwo extends Component {
      ...
      <Container style={styles.container}>
        <Header transparent androidStatusBarColor="#fff">
          ...
          <Right>
            <Button 
              transparent
              onPress={() => this.props.navigation.navigate("ProsesIdentifikasiPartOneMaintenance")}
            >
...
export default ViewPermintaanMaintenancePartTwo;
